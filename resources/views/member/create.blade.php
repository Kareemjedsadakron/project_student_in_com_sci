...
<form 
    ...
    <strong>รหัสนักศึกษา : </strong>
	  <input  type="number"name="student_id"value="{{ isset($member->student_id) ? $member->student_id : '' }}"  class="form-control" 
	  placeholder="รหัสนักศึกษา">
	</div>
	
    <div class="col">
    <strong>ชื่อ : </strong>
      <input type="text" name="name"value="{{ isset($member->name) ? $member->name : '' }}"  class="form-control" placeholder="ชื่อ"></strong>
    </div>

    <div class="col">
    <strong>นามสกุล : </strong>
	  <input type="text" name="lastname"value="{{ isset($member->lastname) ? $member->lastname : '' }}" 
